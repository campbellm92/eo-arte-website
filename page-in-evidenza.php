    ...
    <section class="min-h-screen px-5">
        <?php if ($featured->have_posts()):
            while ($featured->have_posts()):
                $featured->the_post(); ?>
                <div class="flex flex-col items-center md:flex-row w-full gap-4 lg:h-64 hover:bg-red hover:text-gray cursor-pointer"
                    ...
                    <div
                        ...
                        <h3 class="mt-6 md:mt-0 md:w-1/3 leading-tight break-words shrink-0"><?php the_title(); ?></h3>
                        <p class="md:w-1/3 md:mb-0">
                            <?php
                            get_template_part('template-parts/dates/date', get_post_type());
                            ?>
                        </p>
