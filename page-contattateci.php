            ...
            <div class="">
                <form action="/wp-admin/admin-post.php" method="POST" id="contactForm"
                    ...
                    <input type="text" name="name" id="name" placeholder="Inserisci il tuo nome" value=""
                        class="border rounded-xs p-1 mb-4 focus:outline-1 focus:outline-red focus:border-red">
                    <div id="nameError" style="display: none" class="text-red text-sm mb-2 py-2">Inserisci il tuo nome
                    </div>
                    ...
                    <textarea name="message" id="message" placeholder="Scrivi qualcosa"
                        class="border rounded-xs p-1 mb-4 focus:outline-1 focus:outline-red focus:border-red"></textarea>
