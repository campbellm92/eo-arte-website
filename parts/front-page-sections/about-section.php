<!-- about section -->
<section class="flex flex-col p-8 mt-10 min-h-screen w-full md:max-w-10/12 text-center md:text-left">
    <div class="p-5">
        <h1 class="pb-5 text-black">about</h1>
        <p class="text-dark-gray">It's 3am, time to create some chaos commence midnight zoomies yet i
            is
