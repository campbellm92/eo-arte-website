        ...
        <div
            ...
            <?php if ($events->have_posts()):
                while ($events->have_posts()):
                    ...
                    ?>
                    <div
                        class="flex flex-col flex-shrink-0 w-11/12 sm:w-full md:w-2/3 lg:w-1/2 h-auto md:mr-10 bg-gray border-8 border-red rounded-xs snap-start">
                        ...
                        <div class="flex flex-col text-center md:text-left flex-grow p-6">
                            ...
                            <p class="small-text text-red font-semibold">
