<?php
if (is_front_page() || is_page('contattaci')) {
    get_template_part('parts/pre-footer');
}
?>


<footer class="flex flex-col items-center md:flex-row md:justify-between w-full p-8">
